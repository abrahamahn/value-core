...
import { evaluateValueArithmetic, multiplyRationalFloor, parseAmountMinor } from '../src/amount.js';

describe('exact value arithmetic', () => {
  it('accepts only canonical signed 64-bit minor units', () => {
    expect(parseAmountMinor('9223372036854775807')).toBe(9_223_372_036_854_775_807n);
    expect(parseAmountMinor('-9223372036854775808')).toBe(-9_223_372_036_854_775_808n);
